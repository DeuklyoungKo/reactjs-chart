// https://observablehq.com/@d3/bar-chart@206
...
This chart shows the relative frequency of letters in the English language. This is a vertical bar chart, also known as a *column* chart. Compare to a [horizontal bar chart](/@mbostock/d3-horizontal-bar-chart).`
    ...
    main.variable(observer("data")).define("data", ["d3"], async function (d3) {
        return (
            (await d3.csv("https://gist.githubusercontent.com/mbostock/81aa27912ad9b1ed577016797a780b2c/raw/3a807eb0cbb0f5904053ac2f9edf765e2f87a2f5/alphabet.csv", ({letter, frequency}) => ({
                name: letter,
                value: +frequency
